...
public class PaginaListarProduto extends Application {
    ...
    public void start(Stage stage) {
        ...
        nomeColuna.setCellValueFactory(cellData -> new javafx.beans.property.SimpleStringProperty
                (cellData.getValue().getNomeProduto()));

        TableColumn<Produto, String> precoColuna = new TableColumn<>("Preço");
        precoColuna.setCellValueFactory(cellData -> new javafx.beans.property.SimpleStringProperty
                ("R$ " + String.format("%.2f", cellData.getValue().getPreco())));

        TableColumn<Produto, String> condicaoColuna = new TableColumn<>("Condição");
        condicaoColuna.setCellValueFactory(cellData -> new javafx.beans.property.SimpleStringProperty
               (cellData.getValue().getCondicao()));

        TableColumn<Produto, String> categoriaColuna = new TableColumn<>("Categoria");
        categoriaColuna.setCellValueFactory(cellData -> new javafx.beans.property.SimpleStringProperty
